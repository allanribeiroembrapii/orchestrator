...
def processar_excel(arquivo_origem, campos_interesse, novos_nomes_e_ordem, arquivo_destino,
                    campos_data=None, campos_valor=None, campos_string=None):
    # Ler o arquivo Excel
    ...
    if campos_string:
        for campo in campos_string:
            if campo in df_renomeado.columns:
                df_renomeado[campo] = df_renomeado[campo].astype(str).str.strip()
