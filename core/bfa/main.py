...
def main():
    ...
    print("Passo 1/4: Buscando arquivo do BFA no SharePoint...")
    buscar_arquivos_sharepoint()
    zipar_arquivos(COPY, BACKUP)

    # Gerando planilhas a partir do arquivo do BFA
    print("Passo 2/4: Gerando planilhas a partir do arquivo do BFA...")
    gerar_planilhas()

    # Processando as planilhas geradas
    print("Passo 3/4: Processando as planilhas geradas...")
    processar_planilhas()

    # Levando as planilhas processadas para o SharePoint
    print("Passo 4/4: Enviando planilhas processadas para o SharePoint...")
