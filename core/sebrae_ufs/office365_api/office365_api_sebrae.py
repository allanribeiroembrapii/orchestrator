...
class SharePoint:
    def _auth(self):
        conn = ClientContext(SHAREPOINT_SITE_SEBRAE).with_credentials(
            UserCredential(
                USERNAME,
                PASSWORD
            )
    ...
    def _get_files_list(self, folder_name):
        conn = self._auth()
        target_folder_url = f'{SHAREPOINT_DOC_SEBRAE}/{folder_name}'
    ...
    def download_file(self, file_name, folder_name):
        conn = self._auth()
        file_url = f'/sites/{SHAREPOINT_SITE_NAME_SEBRAE}/{SHAREPOINT_DOC_SEBRAE}/{folder_name}/{file_name}'
    ...
    def upload_file(self, file_name, folder_name, content):
        conn = self._auth()
        target_folder_url = f'/sites/{SHAREPOINT_SITE_NAME_SEBRAE}/{SHAREPOINT_DOC_SEBRAE}/{folder_name}'
