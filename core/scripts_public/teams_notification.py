...
def enviar_notificacao_teams(stats):
    ...
    try:
        ...
        if response.status_code in [200, 202]:
            ...
            print(f"Erro ao enviar notificação para o Microsoft Teams: {response.status_code} - {response.text}")
            return False
...
if __name__ == "__main__":
    ...
    stats_teste = {
        ...
        'novos_projetos': 3,
        'novas_empresas': 2,
        'projetos_sem_classificacao': 1,
        'status': 'success'
    }
    
    enviar_notificacao_teams(stats_teste)
