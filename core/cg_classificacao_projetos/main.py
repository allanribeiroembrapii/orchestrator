...
# Importar funções do office365_api
...
RAW_CLASS_PROJETOS = os.path.abspath(os.path.join(CURRENT_DIR, 'step_1_data_raw', 'classificacao_projeto.xlsx'))
RAW_CLASS_PROJETOS_CG = os.path.abspath(os.path.join(CURRENT_DIR, 'step_1_data_raw', 'CG_Classificação de Projetos.xlsx'))
RAW_UE_FONTE_PRIORITARIO = os.path.abspath(os.path.join(CURRENT_DIR, 'step_1_data_raw', 'ue_fonte_recurso_prioritario.xlsx'))
RAW_PORTFOLIO = os.path.abspath(os.path.join(CURRENT_DIR, 'step_1_data_raw', 'portfolio.xlsx'))
SA_CLASS_PROJETOS_CG = os.path.abspath(os.path.join(CURRENT_DIR, 'step_2_stage_area', 'classificacao_projeto_cg.xlsx'))
DP_CLASS_PROJETOS_CG = os.path.abspath(os.path.join(CURRENT_DIR, 'step_3_data_processed', 'classificacao_projeto_cg.xlsx'))
STEP3 = os.path.join(CURRENT_DIR, "step_3_data_processed")
OUTPUT = os.path.join(CURRENT_DIR, "step_3_data_processed")
...
def puxar_planilhas():
    ...
    data_raw = os.path.join(CURRENT_DIR, "step_1_data_raw")
    stage_area = os.path.join(CURRENT_DIR, "step_2_stage_area")
    data_processed = os.path.join(CURRENT_DIR, "step_3_data_processed")
