...
origens = {
    ...
    "projetos_empresas": os.path.join(
        ROOT, "projeto", "projetos_empresas", "step_3_data_processed", "projetos_empresas.xlsx"
    ),
    "informacoes_empresas": os.path.join(
        ROOT, "projeto", "projetos_empresas", "step_3_data_processed", "informacoes_empresas.xlsx"
    ),
