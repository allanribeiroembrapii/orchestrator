...
def processar_dados():
    ...
    negociacoes["parceria_programa"] = negociacoes["parceria_programa"].str.replace(
        r";$", "", regex=True
    )
    negociacoes["call"] = negociacoes["call"].str.replace(r";$", "", regex=True)
    negociacoes["modalidade_financiamento"] = negociacoes["modalidade_financiamento"].str.replace(
        r";$", "", regex=True
    )
