...
PATH_PROJETO = os.path.abspath(
    os.path.join(ROOT, "projeto", "projetos", "step_3_data_processed", "projetos.xlsx")
)
...
def filtrar_projetos(path_arquivo_a_ser_filtrado):
    ...
    arquivo_filtrado = arquivo_a_ser_filtrado[
        arquivo_a_ser_filtrado["codigo_projeto"].isin(lista_projetos)
    ]
