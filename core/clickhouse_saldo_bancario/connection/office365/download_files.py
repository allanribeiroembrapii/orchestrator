...
def get_file(sharepoint_site, sharepoint_site_name, sharepoint_doc, file_n, folder, dest):
    ...
    file_obj = SharePoint().download_file(
        sharepoint_site, sharepoint_site_name, sharepoint_doc, file_n, folder
    )
...
if __name__ == "__main__":
    ...
    if FILE_NAME != "None":
        ...
        get_file(
            SHAREPOINT_SITE_NAME_SEBRAE, SHAREPOINT_DOC_SEBRAE, FILE_NAME, FOLDER_NAME, FOLDER_DEST
        )
